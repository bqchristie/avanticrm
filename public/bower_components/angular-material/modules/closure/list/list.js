 ...
 *     <div class="md-list-item-text" layout.ctrl.js="column">
 *       <p>First Line</p>
 *       <p>Second Line</p>
 *     </div>
 *   </md-list-item>
 ...
 *
 * ### DOM modification
 * The `md-list-item` components automatically detects if the list item should be clickable.
 *
 * ---
 ...
 *
 * ---
 * When using a secondary item inside of your list item, the `md-list-item` components will automatically create
    ...
    compile: function(tEl, tAttrs) {
      ...
      function postLink($scope, $element, $attr, ctrl) {
        ...
        function isEventFromControl(event) {
          ...
          // We iterate the event path up and check for a possible components.
