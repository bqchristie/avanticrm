 ...
 * ### Sidenav
 * <hljs lang="html">
 * <div layout.ctrl.js="row" ng-controller="MyController">
 *   <md-sidenav md-components-id="left" class="md-sidenav-left">
 *     Left Nav!
 *   </md-sidenav>
 *
 *   <md-content>
 ...
 *   </md-content>
 *
 *   <md-sidenav md-components-id="right"
...
function MdConstantFactory() {
  ...
  var self = {
     ...
     *
     * $layout.ctrl.js-breakpoint-xs:     600px !default;
     * $layout.ctrl.js-breakpoint-sm:     960px !default;
     * $layout.ctrl.js-breakpoint-md:     1280px !default;
     * $layout.ctrl.js-breakpoint-lg:     1920px !default;
     *
     */
    MEDIA: {
      'xs'        : '(max-width: 599px)'                         ,
 ...
 *
 * `$mdMedia` also has pre-programmed support for media queries that match the layout.ctrl.js breakpoints:
 *
...
function InterimElementProvider() {
  ...
  function createInterimElementProvider(interimFactoryName) {
    ...
    function factory($$interimElement, $injector) {
       ...
       *
       *  NOTE: This calls the onRemove() subclass method for each components...
...
(function() {
  ...
  var config = {
     ...
     * Developers can use `<body md-layout.ctrl.js-css />` to quickly
   ...
   *
   *  ```html
   *  <div layout.ctrl.js="column"> My Content </div>
   *  ```
   *
   *  ```css
   *  [layout.ctrl.js] {
   ...
   *  browsers... mainly IE.
   *
   *  This module registers directives that allow the same layout.ctrl.js attributes to be
   *  interpreted and converted to class selectors. The directive will add equivalent classes to each element that
   *  contains a Layout directive.
   *
   * ```html
   *   <div layout.ctrl.js="column" class="layout.ctrl.js layout.ctrl.js-column"> My Content </div>
   *```
   *
   *  ```css
   *  .layout.ctrl.js {
  ...
  function registerLayoutAPI(module){
    ...
    var API_WITH_VALUES = [ "layout", "flex", "flex-order", "flex-offset", "layout.ctrl.js-align" ];
    var API_NO_VALUES   = [ "show", "hide", "layout.ctrl.js-padding", "layout.ctrl.js-margin" ];
  ...
  /**
    ...
    * If yes, then immediately disable all layout.ctrl.js API features
    *
  ...
  /**
   * Special directive that will disable ALL Layout conversions of layout.ctrl.js
   * attribute(s) to classname(s).
   *
   * <link rel="stylesheet" href="angular-material.min.css">
   * <link rel="stylesheet" href="angular-material.layout.ctrl.js.css">
   *
   * <body md-layout.ctrl.js-css>
   *  ...
   * </body>
   *
   * Note: Using md-layout.ctrl.js-css directive requires the developer to load the Material
   * Layout Attribute stylesheet (which only uses attribute selectors):
   *
   *       `angular-material.layout.ctrl.js.css`
   *
   * Another option is to use the LayoutProvider to configure and disable the attribute
   * conversions; this would obviate the use of the `md-layout.ctrl.js-css` directive
   *
   */
      ...
      return {
        ...
        compile  : function( element ) {
          ...
          return function( scope, element ) {
            // Wait while layout.ctrl.js injectors configure, then uncloak
   ...
   * @param {string} className attribute name; eg `layout.ctrl.js-gt-md` with value ="row"
   */
  ...
  /**
   * After link-phase, do NOT remove deprecated layout.ctrl.js attribute selector.
   * Instead watch the attribute so interpolated data-bindings to layout.ctrl.js
   * selectors will continue to be supported.
   *
   * $observe() the className and update with new class (after removing the last one)
   *
   * e.g. `layout.ctrl.js="{{layoutDemo.direction}}"` will update...
   *
  ...
  /**
   * Provide console warning that this layout.ctrl.js attribute has been deprecated
   *
   */
  ...
  function validateAttributeValue(className, value, updateFn) {
    ...
    if (!needsInterpolation(value)) {
      switch (className.replace(SUFFIXES,"")) {
        ...
        case 'layout.ctrl.js-align'  :
          var axis = extractAlignAxis(value);
          value = $mdUtil.supplant("{main}-{cross}",axis);
          break;

        case 'layout.ctrl.js-padding' :
        case 'layout.ctrl.js-margin'  :
        case 'layout-fill'    :
        case 'layout-wrap'    :
        case 'layout-nowrap'  :
        case 'layout-nowrap' :
  ...
  function buildUpdateFn(element, className, attrs) {
    return function updateAttrValue(fallback) {
      if (!needsInterpolation(fallback)) {
        ...
        // uses '<ui-layout.ctrl.js layout.ctrl.js="/api/sidebar.html" />' will not
...
angular.module('material.core.meta', [])
   ...
   *
   * @description
   * A components instance registration service.
   * Note: currently this as a private service in the SideNav components.
   */
  ...
  function ComponentRegistry($log, $q) {
    ...
    return self = {
      ...
      /**
       * Async accessor to registered components instance
      ...
      when : function(handle) {
        ...
        return $q.reject("Invalid `md-components-id` value.");
      }
 ...
 *     $mdThemingProvider.registerStyles(require('../styles/my-components.theme.css'));
 *   });
 * </hljs>
 *
 * ### Browser color
