...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		*/
		...
		/**
		 * Updates the chart layout.ctrl.js unless a plugin returns `false` to the `beforeLayout`
...
module.exports = function(Chart) {
	 ...
	 * @prop {String} position - The position of the item in the chart layout.ctrl.js. Possible values are
	 * 'left', 'top', 'right', 'bottom', and 'chartArea'
	 * @prop {Number} weight - The weight used to sort the item. Higher weights are further away from the chart area
	 * @prop {Boolean} fullWidth - if true, and the item is horizontal, then push vertical boxes down
	 * @prop {Function} isHorizontal - returns true if the layout.ctrl.js item is horizontal (ie. top or bottom)
	 * @prop {Function} update - Takes two parameters: width and height. Returns size of item
	 * @prop {Function} getPadding -  Returns an object with padding on the edges
	 * @prop {Number} width - Width of item. Must be valid after update()
	 * @prop {Number} height - Height of item. Must be valid after update()
	 * @prop {Number} left - Left edge of the item. Set by layout.ctrl.js system and cannot be used in update
	 * @prop {Number} top - Top edge of the item. Set by layout.ctrl.js system and cannot be used in update
	 * @prop {Number} right - Right edge of the item. Set by layout.ctrl.js system and cannot be used in update
	 * @prop {Number} bottom - Bottom edge of the item. Set by layout.ctrl.js system and cannot be used in update
	 */

	// The layout.ctrl.js service is very self explanatory.  It's responsible for the layout.ctrl.js within a chart.
	// Scales, Legends and Plugins all rely on the layout.ctrl.js service and can easily register to be placed anywhere they need
	// It is this service's responsibility of carrying out that layout.ctrl.js.
	Chart.layoutService = {
		defaults: {},

		/**
		 * Register a box to a chart.
		 * A box is simply a reference to an object that requires layout.ctrl.js. eg. Scales, Legend, Title.
		 ...
		 * @param {Object} layoutItem - the item to remove from the layout.ctrl.js
		 */
		...
		update: function(chart, width, height) {
			...
			if (!isNaN(padding)) {
				// options.layout.ctrl.js.padding is a number. assign to all
				leftPadding = padding;
			...
			// 4. Give each layout.ctrl.js the maximum size it can be. The layout.ctrl.js will return it's minimum size
			...
			// Let the left layout.ctrl.js know the final margin
			helpers.each(leftBoxes.concat(rightBoxes), finalFitVerticalBox);

			// Recalculate because the size of each layout.ctrl.js might have changed slightly due to the margins (label rotation for instance)
			...
			// Figure out if our chart area changed. This would occur if the dataset layout.ctrl.js label rotation
...
module.exports = function(Chart) {
	 ...
	 * the layout.ctrl.js update is cancelled until another `update` is triggered.
	 * @param {Chart.Controller} chart - The chart instance.
	 * @param {Object} options - The plugin options.
	 * @returns {Boolean} `false` to cancel the chart layout.ctrl.js.
	 */
	/**
	 * @method IPlugin#afterLayout
	 * @desc Called after the `chart` has been layed out. Note that this hook will not
	 * be called if the layout.ctrl.js update has been previously cancelled.
	 * @param {Chart.Controller} chart - The chart instance.
	 * @param {Object} options - The plugin options.
	 */
	/**
