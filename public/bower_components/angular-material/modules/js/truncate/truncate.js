 ...
 * @description
 *
 * The `md-truncate` components displays a label that will automatically clip text which is wider
 * than the components. By default, it displays an ellipsis, but you may apply the `md-clip` CSS
 * class to override this default and use a standard "clipping" approach.
 *
 * <i><b>Note:</b> The `md-truncate` components does not automatically adjust it's width. You must
...
/**
 * Controller for the <md-truncate> components.
 *
