...
function MdAutocompleteCtrl ($scope, $element, $mdUtil, $mdConstant, $mdTheming, $window,
    ...
    switch (event.keyCode) {
      ...
      case $mdConstant.KEY_CODE.ESCAPE:
        ...
        if (hasEscapeOption('blur')) {
          // Force the components to blur if they hit escape
          doBlur(true);
        }
   ...
   * @param value {boolean} Whether or not the components is currently loading.
   */
 ...
 *
 * @description
 * `<md-autocomplete>` is a special input components with a drop-down of all possible matches to a
 *     custom query. This components allows you to provide real-time suggestions as the user types
 *     in the input area.
 *
 ...
 *     different parts that make up our components.
 *
