...
/**
 * Controller for the MdChip components. Responsible for handling keyboard
 ...
 *
 * @description
 * `<md-chip>` is a components used within `<md-chips>` and is responsible for rendering individual
 * chips.
 *
 *
 * @usage
 ...
 * By default the button is not being styled by the `md-chips` components.
 *
 * @usage
 * <hljs lang="html">
 *   <md-chips>
...
/**
 * Controller for the MdChips components. Responsible for adding to and
...
MdChipsCtrl.prototype.shouldAddOnBlur = function() {
  ...
  // Update the custom ngModel validators from the chips components.
  this.validateModel();
...
MdChipsCtrl.prototype.contentIdFor = function(index) {
   ...
   *
   * @description
   * `<md-chips>` is an input components for building lists of strings or objects. The list items are
   * displayed as 'chips'. This components can make use of an `<input>` element or an 
   ...
   * ### Accessibility
   *
   * The `md-chips` components supports keyboard and screen reader users since Version 1.1.2. In
   ...
   * @param {string=} md-chip-append-delay The number of milliseconds that the components will select
...
/**
 * Controller for the MdContactChips components
 * @constructor
 */
 ...
 *
 * @description
 * `<md-contact-chips>` is an input components based on `md-chips` and makes use of an
 * `md-autocomplete` element. The components allows the caller to supply a query expression which
